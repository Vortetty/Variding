...
# you need smth to get i from a value
...
def num2base(i, base, shiftn):
    convertString = "".join(lists["16"])  # "".join(rotate(lists["16"],shiftn))
    if i < base:
        return convertString[i]
    else:
        return num2base(i // base, base, shiftn) + convertString[i % base]


def base2num(number, base, shiftn):
